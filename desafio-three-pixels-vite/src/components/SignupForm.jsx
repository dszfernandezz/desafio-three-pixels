        ...
        <div className="bg-white rounded-4xl shadow-xl p-10">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="forms-botao mt-8 flex items-center justify-center w-full md:col-span-2">
              <button
                className="w-full bg-purple-600 hover:bg-purple-800 disabled:bg-gray-300 text-white font-medium py-3 px-4 rounded-lg transition duration-150  hover:shadow-lg"
